...
def run_yolo():
    ...
    ai_enable_sub = rospy.Subscriber("ai_enable_action", Int32, ai_enableCallback)
    ball_verification_sub = rospy.Subscriber("colour_ball", Int32, ball_clrCallback)
    ...
    our_ball = 0  # Set this to 0 for blue ball, 1 for red ball
        ...
        if switch_camera_ball_pick:
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    if class_names.get(str(c)) not in ["blue", "silo"]:
                        continue
